  ...
  return (
    ...
    >
      ...
      <p className="text-md font-firaCode uppercase">
        ...
        When I&apos;m not staring at a screen, you can either find me running
        for hours just to end up in the same place I started, or trying to
        convince my cat that I&apos;m in charge. I can&apos;t resist a challenge
        and when it comes to code I believe in creating maintainable,
        performant, accessible and secure solutions that are not just
      ...
      <div>
        ...
        <ul className="text-md list-outside list-disc pl-6 font-firaCode">
          <li className="mb-4">
            Developed and maintained features on large-scale Ruby on Rails
            applications with millions of users worldwide, using best practices
            in software development and working closely with cross-functional
            teams to deliver high-quality code on tight timelines.
          </li>
          <li className="mb-4">
          ...
          <li className="mb-4">
            ...
            GraphQL Rails API and wrote queries and mutations to fetch the data
            using Apollo Client. Leveraged Apollo Client features to delay
            execution of the queries until needed, reducing any unnecessary API
            calls. Implemented Lodash debouncing to prevent multiple API calls
            for the same data within a short period of time resulting in a
            faster, optimized dashboard and improved overall user experience.
          </li>
          <li className="mb-4">
            ...
            applications. Utilized various testing frameworks and tools, such as
            Factory Bot and Faker, to generate test data and streamline the
            testing process.
          </li>
          <li className="mb-4">
          ...
          <li className="mb-4">
            ...
            reliability through effective testing and monitoring with Datadog as
            well as Bugsnag to monitor the application and quickly identify and
            resolve issues before users were impacted.
          </li>
        </ul>
      </div>
    </section>
