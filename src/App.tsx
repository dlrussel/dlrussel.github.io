  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="button"
          className="bg-white hover:bg-white/70 my-6 rounded-lg border-2 border-red px-5 py-3 font-rubikMono uppercase transition-all hover:border-[#ae0000] hover:text-[#ae0000]"
          onClick={(e) => {
